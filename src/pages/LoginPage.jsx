    ...
    return(
        <Box textAlign={"center"}>
            <Paper elevation={10} style={paperStyle}>
                ...
                <TextField style={inputStyle} label='Username' placeholder='Enter username' fullWidth required/>
                <TextField style={inputStyle} label='Password' placeholder='Enter password' type='password' fullWidth required/>
                <FormControlLabel
                    control={
                    <Checkbox
                        name="checkedB"
